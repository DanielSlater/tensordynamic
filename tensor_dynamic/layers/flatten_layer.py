...
class FlattenLayer(BaseLayer):
    ...
    def activation_predict(self):
        self._reshape_predict = self._layer_activation(self.input_layer.activation_predict, False)
        return self._reshape_predict

    @lazyprop
    def activation_train(self):
        self._reshape_train = self._layer_activation(self.input_layer.activation_train, False)
        return self._reshape_train
